...
if (isset($_GET['edit'])) {
    ...
    $select = $conn->prepare("SELECT * FROM sweetsproducts WHERE id = ?");
    ...
    if (empty($product_name) || empty($sub_product_name) || empty($sub_product_name) || empty($product_price)) {
        ...
        if (!empty($product_image)) {
            ...
            if (in_array(strtolower($file_extension), $allowed_extensions)) {
                ...
                $update = "UPDATE sweetsproducts SET product_name='$product_name', sub_product_name='$sub_product_name', product_price='$product_price', product_image='$product_image' WHERE id='$id'";
            } else {
                $message[] = 'Invalid image format. Only JPG, JPEG, and PNG are allowed.';
            }
        } else {
            // Update without changing the image
            $update = "UPDATE sweetsproducts SET product_name='$product_name', sub_product_name='$sub_product_name', product_price='$product_price' WHERE id='$id'";
        }
...
<div class="admin-product-form-container centered">
   ...
   <?php
      ...
      $select = mysqli_query($conn, "SELECT * FROM sweetsproducts WHERE id = $id");
   ...
   <form action="" method="post" enctype="multipart/form-data" 
      ...
      <a href="sweetsProductController.php" 
