...
<head>
    ...
    <title>Crunchy Sweet | Cake Product</title>
    ...
    <main>
        ...
        <div class="bg-gray-100 py-10">
            <div class="max-w-screen-xl mx-auto px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-8">
                ...
                <div class="w-full lg:w-1/2">
                    <h2 class="text-3xl font-bold text-gray-800 mb-4">Welcome to Our Cake Shop</h2>
                    <p class="text-gray-700 leading-relaxed">
                        Experience the joy of delightful cakes, crafted to perfection with the finest ingredients and a
                        touch of creativity. From elegant designs to mouthwatering flavors, our cakes are more than just
                        desserts – they’re moments of pure happiness.
                    </p>
                    <p class="text-gray-700 leading-relaxed mt-4">
                        Perfect for celebrations or simply to satisfy your sweet cravings, each cake is made with care
                        to ensure every bite is as special as the occasion. Explore our irresistible collection and make
                        your moments memorable with the magic of our signature cakes.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-screen-xl mx-auto">
            ...
            <section class="products py-10 space-y-10">
                ...
                $select_product_names = mysqli_query($conn, "SELECT DISTINCT `product_name` FROM `cakeproducts`");
                    ...
                    while ($product_name_row = mysqli_fetch_assoc($select_product_names)) {
                        ...
                        <div>
                            ...
                            <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
                                <?php
                                $select_products = mysqli_query($conn, "SELECT * FROM `cakeproducts` WHERE `product_name` = '$product_name'");
