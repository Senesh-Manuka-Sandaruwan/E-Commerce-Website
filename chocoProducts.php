   ...
   <div class="max-w-screen-xl mx-auto px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-8">
      ...
      <div class="w-full lg:w-1/2">
         ...
         <p class="text-gray-700 leading-relaxed">
            ...
            Our collection includes a variety of delightful flavors and exquisite designs, perfect for any occasion. 
            Whether you're treating yourself or gifting a loved one, our chocolates promise to deliver an unforgettable experience.
         </p>
         <p class="text-gray-700 leading-relaxed mt-4">
            Explore our range of premium chocolates and let your taste buds embark on a journey of pure delight. 
   ...
   <section class="products py-10 space-y-10">
      ...
      <div>
         ...
         <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
            ...
            <form action="" method="post" class="bg-white shadow-md border border-gray-300 rounded-lg p-6 text-center">
               <div class="box">
                  ...
                  <input type="submit" class="bg-green-500 text-white px-6 py-2 rounded hover:bg-green-600 transition-colors cursor-pointer" value="Add to Cart" name="add_to_cart">
               </div>
            </form>
