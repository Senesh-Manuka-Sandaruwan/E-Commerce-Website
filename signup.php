            ...
            <div class="bg-white/40 p-10 rounded-lg shadow-lg max-w-md w-full mt-10 mb-10">
                ...
                <form action="login_process.php" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="contactnumber" name="contactnumber" id="contactnumber" placeholder="Contact Number"
                            class="w-full mt-2 px-4 py-2 border rounded-lg focus:ring focus:ring-amber-300 outline-none"
                            required>
                    </div>
                    <div>
                    ...
                    <div>
                        <label for="conformpassword" class="block text-black font-bold">Conform Password</label>
                        <input type="conformpassword" name="conformpassword" id="conformpassword"
                    ...
                    <div class="flex items-start">
                        ...
                        <label for="terms" class="ml-2 text-sm">
                            <a href="terms.html" target="_blank" class="text-black font-bold underline">I agree to the Terms and
                                Conditions..</a>
                        </label>
                    </div>
                    <button type="submit"
